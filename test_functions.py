...
import numpy as np
import pytest
from fehlerrechnung_funktionen import roundwitherror, list_error_calc, getdecimals
...
pairs = ((123, -2), (0.123, 1), (0.02432, 2), (0.01, 2), (0.001, 3))

@pytest.mark.parametrize("pair", pairs)
def test_getdecimals(pair):
    assert pair[1] == getdecimals(pair[0])
